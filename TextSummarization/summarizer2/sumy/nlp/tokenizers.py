...
class VietnamSentencesTokenizer:
    def tokenize(self, text):
        try:
            from nltk.tokenize import sent_tokenize
        except ImportError as e:
            raise ValueError("Vietnam tokenizer requires nltk. Please, install it by command 'pip install nltk'.")
...
class VietnamWordTokenizer:
    def tokenize(self, text):
        try:
            ...
            raise ValueError("Vietnam word tokenizer requires VnCoreNLP. Please, install it by command 'pip install vncorenlp'.")
...
class Tokenizer(object):
    ...
    SPECIAL_SENTENCE_TOKENIZERS = {
        'vietnam':VietnamSentencesTokenizer()
    }

    SPECIAL_WORD_TOKENIZERS = {
        'vietnam':VietnamWordTokenizer()
    }
